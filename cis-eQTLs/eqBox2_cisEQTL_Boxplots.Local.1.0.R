...
message("## qrsh -l rstudio; R --vanilla; /path/R-devel-dist/bin/R; ~xxvjc/bin/Rdevel --vanilla;                   ##")
message("## `/xxx/xxvjc/bin/Rdevel RHOME`/bin/Rscript                                                              ##")
message("##                                                                                                        ##")
message("## Run R script in Channing:                                                                              ##")
message("## nohup R --no-save < myRscript.R > myRscriptR.out &                                                     ##")
message("## R --vanilla < /xxx/xxtwc/R/test.R > /xxx/xxtwc/R/testR.out ; qsub -l lx ./runMyRscript.sh              ##")
message("##                                                                                                        ##")
...
sessionInfo()
# installed.packages()
# .libPaths("/xxx/xxtwc/R/library/3.1")
