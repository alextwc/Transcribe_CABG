#!/usr/bin/Rscript
message("############################################################################################################")
message("## R-script to run PEER10 & gQTLstats on Transcribe118 RNA-Seq for Response-Delta cis-eQTL with 3 PCs     ##")
message("##                                                                                                        ##")
message("##  Author: Dr. Alex Tzuu-Wang Chang                                                                      ##")
message("##    Date: 2016-09-27                                                                                    ##")
message("##                                                                                                        ##")
message("## Version: 1.0 For re-running of 2016-09-08 Response cis-eQTL with 3 PCs                             ##")
message("##                                                                                                        ##") 
...
rm(weights)
message("###############################################################################")
message("# Finished the first PEER10 pass for Sex,Age,ReadLength,SeqCenter with 3 PCs  #")
