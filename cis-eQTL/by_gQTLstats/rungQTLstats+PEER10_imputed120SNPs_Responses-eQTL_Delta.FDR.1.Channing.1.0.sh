#!/bin/bash
#=============================================================================#
#Title           :rungQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Delta.    #
...
#=============================================================================#
#$ -N rungQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Delta.FDR.1.Channing.1.0.sh
...
SourceDIR="/path/analyses/retwc/20160923reRUN01"
  DestDIR="/path/analyses/retwc/20160923reRUN01"
echo
...
( /app/R-3.3.1@i86-rhel6.0/bin/Rscript ./gQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Delta.FDR.1.Channing.1.0.R ./InputFiles/LV135preX.csv ./InputFiles/LV133postX.csv ./InputFiles/CovariancesAll.csv) >& run.$dtime.$$.$JOB_NAME.log
echo
