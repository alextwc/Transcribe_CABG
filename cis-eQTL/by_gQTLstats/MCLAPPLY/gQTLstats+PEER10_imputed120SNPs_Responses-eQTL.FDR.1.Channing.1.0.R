#!/usr/bin/Rscript
message("############################################################################################################")
message("## R-script to run PEER10 & gQTLstats on Transcribe120 RNA-Seq for Response-specific cis-eQTL analyses    ##")
message("##                                                                                                        ##")
...
message("###############################################################################")
print(Sys.time())
setwd("/path/retwc/20160902gQTLstatsEQTL_Responses")
...
base.dir <- getwd();
    odir <- getwd();
set.seed(12345)
imputed_all <- "/path/imputed/20160818/VCF-IR/Transcribe120_AllChr22_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_01  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr01_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_02  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr02_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_03  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr03_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_04  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr04_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_05  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr05_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_06  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr06_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_07  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr07_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_08  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr08_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_09  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr09_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_10  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr10_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_11  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr11_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_12  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr12_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_13  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr13_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_14  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr14_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_15  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr15_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_16  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr16_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_17  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr17_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_18  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr18_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_19  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr19_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_20  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr20_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_21  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr21_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_22  <- "/path/imputed/20160818/VCF-IR/Transcribe120_Chr22_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_23  <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh23.vcf-IR.vcf.gz"
vcfpath_24  <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh24.vcf-IR.vcf.gz"
vcfpath_25  <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh25.vcf-IR.vcf.gz"
vcfpath_26  <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh26.vcf-IR.vcf.gz"
...
rm(weights)
message("###############################################################################")
message("# Finished the first PEER10 pass for Sex,Age,ReadLength,SeqCenter,genoPC1~PC3 #")
...
phenotypesResidual  <-  phenotypesResidual[intersect(rownames(phenotypesResidual), colnames(deltaResidual)), ]
...
# Cvrt <- Cvrt[, -1]
Cvrt <- Cvrt[intersect(rownames(Cvrt), colnames(deltaResidual)), ]
message("# Subjects of PEER_Known_Covariate_Table were reduced from 169 to 120; 49 persons were removed by intersection ")
...
STATES  <- c("deltaResidual", "ratioResidual")
STATUS  <- c("Delta",         "Ratio")
 PHENO  <- c("pheno",         "pheno")
   COV  <- c("Cvrt",          "Cvrt")
...
for ( si in imputation) {
    ...
    if ( snps=="nonimputed" ) {
      ...
      message("###############################################################################")
      vcfpath_01 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh1.vcf-IR.vcf.gz"
      vcfpath_02 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh2.vcf-IR.vcf.gz"
      vcfpath_03 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh3.vcf-IR.vcf.gz"
      vcfpath_04 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh4.vcf-IR.vcf.gz"
      vcfpath_05 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh5.vcf-IR.vcf.gz"
      vcfpath_06 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh6.vcf-IR.vcf.gz"
      vcfpath_07 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh7.vcf-IR.vcf.gz"
      vcfpath_08 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh8.vcf-IR.vcf.gz"
      vcfpath_09 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh9.vcf-IR.vcf.gz"
      vcfpath_10 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh10.vcf-IR.vcf.gz"
      vcfpath_11 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh11.vcf-IR.vcf.gz"
      vcfpath_12 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh12.vcf-IR.vcf.gz"
      vcfpath_13 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh13.vcf-IR.vcf.gz"
      vcfpath_14 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh14.vcf-IR.vcf.gz"
      vcfpath_15 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh15.vcf-IR.vcf.gz"
      vcfpath_16 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh16.vcf-IR.vcf.gz"
      vcfpath_17 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh17.vcf-IR.vcf.gz"
      vcfpath_18 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh18.vcf-IR.vcf.gz"
      vcfpath_19 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh19.vcf-IR.vcf.gz"
      vcfpath_20 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh20.vcf-IR.vcf.gz"
      vcfpath_21 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh21.vcf-IR.vcf.gz"
      vcfpath_22 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh22.vcf-IR.vcf.gz"
      vcfpath_23 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh23.vcf-IR.vcf.gz"
      vcfpath_24 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh24.vcf-IR.vcf.gz"
      vcfpath_25 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh25.vcf-IR.vcf.gz"
      vcfpath_26 <- "/path/non-imputed/VCF-IR/Merged142FinalReportCh26.vcf-IR.vcf.gz"
    ...
    N=seq(2)
    for(i in N){
        fdname <- STATES[i] #("deltaResidual","ratioResidual")
        status <- STATUS[i] #("Delta","Ratio")
        ...
        # load("./covs.rda")
        print(Sys.time())
        K=c(2,10) # Can't run k=0 when not include the known covariates
        for(k in K) {
