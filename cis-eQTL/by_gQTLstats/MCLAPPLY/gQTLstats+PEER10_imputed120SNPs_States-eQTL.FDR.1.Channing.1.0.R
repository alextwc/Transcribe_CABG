#!/usr/bin/Rscript
message("############################################################################################################")
message("## R-script to run PEER10 & gQTLstats on Transcribe120 RNA-Seq for States-specific cis-eQTL analyses      ##")
message("##                                                                                                        ##")
message("##  Author: Dr. Alex Tzuu-Wang Chang                                                                      ##")
message("##    Date: 2016-09-02                                                                                    ##")
message("##                                                                                                        ##")
message("## Version: 1.0 Setting the path variables for imputed Transcribe-120 genotyping dataset                  ##")
message("##                                                                                                        ##") 
...
message("## qrsh -l rstudio; R --vanilla; /path/stvjc/VM/R-devel-dist/bin/R; ~stvjc/bin/Rdevel --vanilla;           ##")
message("## `/path/stvjc/bin/Rdevel RHOME`/bin/Rscript                                                              ##")
message("##                                                                                                        ##")
message("## Run R script in Channing:                                                                              ##")
message("## nohup R --no-save < myRscript.R > myRscriptR.out &                                                     ##")
message("## R --vanilla < /path/retwc/R/test.R > /path/retwc/R/testR.out ; qsub -l lx ./runMyRscript.sh              ##")
message("##                                                                                                        ##")
...
sessionInfo()
# installed.packages()
# .libPaths("/path/retwc/R/library/3.1")
# .libPaths( c( .libPaths(), "/path/retwc/R/library/3.1") )
...
message("###############################################################################")
print(Sys.time())
setwd("/path/analyses/retwc/20160902gQTLstatsEQTL_States")
require("peer", lib.loc="/path/retwc/R")
...
base.dir <- getwd();
    odir <- getwd();
set.seed(12345)
imputed_all <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_AllChr22_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_01  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr01_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_02  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr02_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_03  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr03_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_04  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr04_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_05  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr05_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_06  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr06_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_07  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr07_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_08  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr08_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_09  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr09_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_10  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr10_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_11  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr11_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_12  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr12_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_13  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr13_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_14  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr14_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_15  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr15_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_16  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr16_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_17  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr17_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_18  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr18_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_19  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr19_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_20  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr20_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_21  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr21_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_22  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/imputed/20160818/VCF-IR/Transcribe120_Chr22_imputed_MAF0.15passed.vcf-IR.vcf.gz"
vcfpath_23  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh23.vcf-IR.vcf.gz"
vcfpath_24  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh24.vcf-IR.vcf.gz"
vcfpath_25  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh25.vcf-IR.vcf.gz"
vcfpath_26  <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh26.vcf-IR.vcf.gz"
...
message("# The regressOut(Sex, Age, seqCenter, reads, AXC_time) is prepared for gQTLstats #")
message("##################################################################################")
print(Sys.time())
mergedID <- read.table("./InputFiles/geneid.mergedID", header = TRUE, stringsAsFactors = FALSE)
...
phenotypesPost <- subset(phenotypes, exclude==0, select=-c(ID,Sequence,LVEF,Weight,Height,BMI,CAD,DM,HgbA1C,BAV,CKMB_day1,beta_blocker,exclude))
...
CovsPost = subset(CovsPost, exclude==0, select=-c(ID,Sequence,LVEF,Weight,Height,BMI,CAD,DM,HgbA1C,BAV,CKMB_day1,beta_blocker,exclude))
...
message("# Making the 2nd loop to run gQTLstats sequentially on PRE and POST datasets    #")
...
STATES  <- c("exprPre",       "exprPost")
STATUS  <- c("Baseline",      "Ischemia")
 PHENO  <- c("phenotypesPre", "phenotypesPost")
   COV  <- c("CovsPre",       "CovsPost")
  SNPs  <- c("imputed",       "nonimputed")
imputation=seq(2)
for ( si in imputation) {
    snps <- SNPs[si]
    if ( snps=="nonimputed" ) {
    	message("                                                                               ")
      message("###############################################################################")
      message("#                Using non-imputed SNPs for gQTLstats                         #")
      message("#              Setting the paths for non-imputed SNPs now                     #")
      message("###############################################################################")
      vcfpath_01 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh1.vcf-IR.vcf.gz"
      vcfpath_02 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh2.vcf-IR.vcf.gz"
      vcfpath_03 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh3.vcf-IR.vcf.gz"
      vcfpath_04 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh4.vcf-IR.vcf.gz"
      vcfpath_05 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh5.vcf-IR.vcf.gz"
      vcfpath_06 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh6.vcf-IR.vcf.gz"
      vcfpath_07 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh7.vcf-IR.vcf.gz"
      vcfpath_08 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh8.vcf-IR.vcf.gz"
      vcfpath_09 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh9.vcf-IR.vcf.gz"
      vcfpath_10 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh10.vcf-IR.vcf.gz"
      vcfpath_11 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh11.vcf-IR.vcf.gz"
      vcfpath_12 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh12.vcf-IR.vcf.gz"
      vcfpath_13 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh13.vcf-IR.vcf.gz"
      vcfpath_14 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh14.vcf-IR.vcf.gz"
      vcfpath_15 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh15.vcf-IR.vcf.gz"
      vcfpath_16 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh16.vcf-IR.vcf.gz"
      vcfpath_17 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh17.vcf-IR.vcf.gz"
      vcfpath_18 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh18.vcf-IR.vcf.gz"
      vcfpath_19 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh19.vcf-IR.vcf.gz"
      vcfpath_20 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh20.vcf-IR.vcf.gz"
      vcfpath_21 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh21.vcf-IR.vcf.gz"
      vcfpath_22 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh22.vcf-IR.vcf.gz"
      vcfpath_23 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh23.vcf-IR.vcf.gz"
      vcfpath_24 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh24.vcf-IR.vcf.gz"
      vcfpath_25 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh25.vcf-IR.vcf.gz"
      vcfpath_26 <- "/path/data/rnaseq/TRANSCRiBE142Genotypes/non-imputed/VCF-IR/Merged142FinalReportCh26.vcf-IR.vcf.gz"
    ...
    N=seq(2)
    for(i in N){
        fdname <- STATES[i] #(exprPre, exprPost)
        status <- STATUS[i] #(Baseline, Ischemia)
        ...
        # load("./covs.rda")
        print(Sys.time())
        K=c(1,10) # Can't run k=0 when not include the known covariates
        for(k in K) {
            ...
            pdf(file=paste("./diagnostics_PEER-", k, "_", status, ".pdf", sep=""), paper="usr", width = 0, height = 0)
            ...
            write.csv(residuals, file=paste("./residuals_PEER-", k, "_", status, ".csv", sep=""), row.names=TRUE)
            write.csv(factors,   file=paste("./factors_PEER-", k, "_", status, ".csv", sep=""), row.names=TRUE)
            # Please disable write.csv(getCovs, ....) while running PEER without including the known covariates
            write.csv(getCovs,   file=paste("./getCovs_PEER-", k, "_", status, ".csv", sep=""), row.names=TRUE)
            write.csv(weights,   file=paste("./weights_PEER-", k, "_", status, ".csv", sep=""), row.names=TRUE)
            write.csv(precision,   file=paste("./precision_PEER-", k, "_", status, ".csv", sep=""), row.names=FALSE)
            pdf(file=paste("./precision_PEER-", k, "_", status, ".pdf", sep=""))
             plot(precision)
             mtext(paste0("PEER factor = ", k), side=3, line=-1)
            dev.off()
            ...
            mcores <- detectCores()
            message("# Multicores environment has been detected with available ", mcores, " cores")
            # cat /proc/cpuinfo | grep processor | wc # Another way to find how many cores are available
            message("# Starting splitting exprSE(SummarizedExperiment) object ", fdname, " to individual chromosomal SE objects ")
            message("# Initializing the Multicore Parallel Computation by calling mclapply function now ")
            print(Sys.time())
            
            exprSE01 = exprSE[ seqnames(exprSE) == "chr1" , ]
            seqlevelsStyle(exprSE01) = "NCBI"
            exprSE02 = exprSE[ seqnames(exprSE) == "chr2" , ]
            seqlevelsStyle(exprSE02) = "NCBI"
            exprSE03 = exprSE[ seqnames(exprSE) == "chr3" , ]
            seqlevelsStyle(exprSE03) = "NCBI"
            exprSE04 = exprSE[ seqnames(exprSE) == "chr4" , ]
            seqlevelsStyle(exprSE04) = "NCBI"
            exprSE05 = exprSE[ seqnames(exprSE) == "chr5" , ]
            seqlevelsStyle(exprSE05) = "NCBI"
            exprSE06 = exprSE[ seqnames(exprSE) == "chr6" , ]
            seqlevelsStyle(exprSE06) = "NCBI"
            exprSE07 = exprSE[ seqnames(exprSE) == "chr7" , ]
            seqlevelsStyle(exprSE07) = "NCBI"
            exprSE08 = exprSE[ seqnames(exprSE) == "chr8" , ]
            seqlevelsStyle(exprSE08) = "NCBI"
            exprSE09 = exprSE[ seqnames(exprSE) == "chr9" , ]
            seqlevelsStyle(exprSE09) = "NCBI"
            exprSE10 = exprSE[ seqnames(exprSE) == "chr10", ]
            seqlevelsStyle(exprSE10) = "NCBI"
            exprSE11 = exprSE[ seqnames(exprSE) == "chr11", ]
            seqlevelsStyle(exprSE11) = "NCBI"
            exprSE12 = exprSE[ seqnames(exprSE) == "chr12", ]
            seqlevelsStyle(exprSE12) = "NCBI"
            exprSE13 = exprSE[ seqnames(exprSE) == "chr13", ]
            seqlevelsStyle(exprSE13) = "NCBI"
            exprSE14 = exprSE[ seqnames(exprSE) == "chr14", ]
            seqlevelsStyle(exprSE14) = "NCBI"
            exprSE15 = exprSE[ seqnames(exprSE) == "chr15", ]
            seqlevelsStyle(exprSE15) = "NCBI"
            exprSE16 = exprSE[ seqnames(exprSE) == "chr16", ]
            seqlevelsStyle(exprSE16) = "NCBI"
            exprSE17 = exprSE[ seqnames(exprSE) == "chr17", ]
            seqlevelsStyle(exprSE17) = "NCBI"
            exprSE18 = exprSE[ seqnames(exprSE) == "chr18", ]
            seqlevelsStyle(exprSE18) = "NCBI"
            exprSE19 = exprSE[ seqnames(exprSE) == "chr19", ]
            seqlevelsStyle(exprSE19) = "NCBI"
            ...
            expr.list <- list(list(exprSE01,tf01), list(exprSE02,tf02), list(exprSE03,tf03), list(exprSE04,tf04), list(exprSE05,tf05), 
                              list(exprSE06,tf06), list(exprSE07,tf07), list(exprSE08,tf08), list(exprSE09,tf09), list(exprSE10,tf10), 
                              list(exprSE11,tf11), list(exprSE12,tf12), list(exprSE13,tf13), list(exprSE14,tf14), list(exprSE15,tf15), 
                              list(exprSE16,tf16), list(exprSE17,tf17), list(exprSE18,tf18), list(exprSE19,tf19), list(exprSE20,tf20), 
                              list(exprSE21,tf21), list(exprSE22,tf22))
            message("# Finishing splitting exprSE(SummarizedExperiment) object of ", fdname)
            print(Sys.time())
            
            message("# Running cisAssoc() by mclapply function now ")
            print(Sys.time())
            ...
            message("# Finishing mclapply function now ")
            print(Sys.time())
            ...
            save(exprSeQTL_fdr.1,  file=paste("./StateseQTL_", status, "_", snps, "_", fdname, "_FDR.1_PEER-", k, ".rda", sep=""))
            save(exprSeQTL_fdr.05, file=paste("./StateseQTL_", status, "_", snps, "_", fdname, "_FDR.05_PEER-", k, ".rda", sep=""))
            write.csv(exprSeQTL_fdr.1,  file=paste("./StateseQTL_", status, "_", snps, "_", fdname, "_FDR.1_PEER-", k, ".csv", sep=""), row.names=FALSE)
            write.csv(exprSeQTL_fdr.05, file=paste("./StateseQTL_", status, "_", snps, "_", fdname, "_FDR.05_PEER-", k, ".csv", sep=""), row.names=FALSE)
            # print(unlist(res))
            ...
            message("###############################################################################")
            message("###############################################################################")
            message("# The current state-specific dataset is ", status)
