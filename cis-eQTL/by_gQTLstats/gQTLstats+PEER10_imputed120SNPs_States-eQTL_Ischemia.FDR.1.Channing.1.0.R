#!/usr/bin/Rscript
message("############################################################################################################")
message("## R-script to run PEER10 & gQTLstats on Transcribe118 RNA-Seq for Ischemia State cis-eQTL analyses       ##")
message("##                                                                                                        ##")
message("##  Author: Dr. Alex Tzuu-Wang Chang                                                                      ##")
message("##    Date: 2016-09-27                                                                                    ##")
message("##                                                                                                        ##")
message("## Version: 1.0 For re-running of 2016-09-08 State cis-eQTL                                               ##")
message("##                                                                                                        ##") 
...
message("###############################################################################")
print(Sys.time())
setwd("/path/analyses/retwc/20160923reRUN01")
