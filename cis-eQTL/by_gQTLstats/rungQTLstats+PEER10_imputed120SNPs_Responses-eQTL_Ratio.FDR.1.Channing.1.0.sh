#!/bin/bash
#=============================================================================#
#Title           :rungQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Ratio.    #
...
#=============================================================================#
#$ -N rungQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Ratio.FDR.1.Channing.1.0.sh
...
( /app/R-3.3.1@i86-rhel6.0/bin/Rscript ./gQTLstats+PEER10_imputed120SNPs_Responses-eQTL_Ratio.FDR.1.Channing.1.0.R ./InputFiles/LV135preX.csv ./InputFiles/LV133postX.csv ./InputFiles/CovariancesAll.csv) >& run.$dtime.$$.$JOB_NAME.log
echo
